...
public class Grid {
	...
	//function pour verifier si la matrice est arrivee a la fin de ses cases libres
	...
	//verification si je peux les mettre sur grid
	public int isFree(Ships s) {
		...
		} else {return veri;} //others problemes
